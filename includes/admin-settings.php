    ...
    ?>
            <table class="form-table">
              <?php if ( current_user_can( 'manage_options' ) ) { ?>
                <tr valign="top">
                  <th scope="row">
                    <label for="minimum_role">
                      <?php _e( 'Minimum Role to Administer Open Badge Factory plugin: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                    <select id="minimum_role" name="badgeos_settings[minimum_role]">
                      <option value="manage_options" <?php selected( $minimum_role, 'manage_options' ); ?>>
                        <?php _e( 'Administrator', 'badgeos' ); ?>
                      </option>
                      <option value="delete_others_posts" <?php selected( $minimum_role, 'delete_others_posts' ); ?>>
                        <?php _e( 'Editor', 'badgeos' ); ?>
                      </option>
                      <option value="publish_posts" <?php selected( $minimum_role, 'publish_posts' ); ?>>
                        <?php _e( 'Author', 'badgeos' ); ?>
                      </option>
                    </select>
                  </td>
                </tr>
                <tr valign="top">
                  <th scope="row">
                    <label for="submission_manager_role">
                      <?php _e( 'Minimum Role to Administer Submissions/Nominations: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                    <select id="submission_manager_role" name="badgeos_settings[submission_manager_role]">
                      <option value="manage_options" <?php selected( $submission_manager_role, 'manage_options' ); ?>>
                        <?php _e( 'Administrator', 'badgeos' ); ?>
                      </option>
                      <option value="delete_others_posts" <?php selected( $submission_manager_role, 'delete_others_posts' ); ?>>
                        <?php _e( 'Editor', 'badgeos' ); ?>
                      </option>
                      <option value="publish_posts" <?php selected( $submission_manager_role, 'publish_posts' ); ?>>
                        <?php _e( 'Author', 'badgeos' ); ?>
                      </option>
                    </select>
                  </td>
                ...
                <tr valign="top">
                  <th scope="row">
                    <label for="achievement_creator_role">
                      <?php _e( 'Minimum Role to create Badges/Achievements: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                    <select id="achievement_creator_role" name="badgeos_settings[achievement_creator_role]">
                      <option value="manage_options" <?php selected( $achievement_creator_role, 'manage_options' ); ?>>
                        <?php _e( 'Administrator', 'badgeos' ); ?>
                      </option>
                      <option value="delete_others_posts" <?php selected( $achievement_creator_role, 'delete_others_posts' ); ?>>
                        <?php _e( 'Editor', 'badgeos' ); ?>
                      </option>
                      <option value="publish_posts" <?php selected( $achievement_creator_role, 'publish_posts' ); ?>>
                        <?php _e( 'Author', 'badgeos' ); ?>
                      </option>
                      <option value="edit_posts" <?php selected( $achievement_creator_role, 'edit_posts' ); ?>>
                        <?php _e( 'Contributor', 'badgeos' ); ?>
                      </option>
                    </select>
                  </td>
                </tr>
                <?php } /* endif current_user_can( 'manage_options' ); */ ?>
                  <tr valign="top">
                    <th scope="row">
                      <label for="submission_email">
                        <?php _e( 'Send email when submissions/nominations are received:', 'badgeos' ); ?>
                      </label>
                    </th>
                    <td>
                      <select id="submission_email" name="badgeos_settings[submission_email]">
                        <option value="enabled" <?php selected( $submission_email, 'enabled' ); ?>>
                          <?php _e( 'Enabled', 'badgeos' ) ?>
                        </option>
                        <option value="disabled" <?php selected( $submission_email, 'disabled' ); ?>>
                          <?php _e( 'Disabled', 'badgeos' ) ?>
                        </option>
                      </select>
                    </td>
                  </tr>
                  ...
                  <tr valign="top">
                    <th scope="row">
                      <label for="show_advanced_features">
                        <?php _e( 'Show advanced features:', 'badgeos' ); ?>
                      </label>
                    </th>
                    <td>
                      <select id="show_advanced_features" name="badgeos_settings[show_advanced_features]">
                        <option value="enabled" <?php selected( $show_advanced_features, 'enabled' ); ?>>
                          <?php _e( 'Enabled', 'badgeos' ) ?>
                        </option>
                        <option value="disabled" <?php selected( $show_advanced_features, 'disabled' ); ?>>
                          <?php _e( 'Disabled', 'badgeos' ) ?>
                        </option>
                      </select>
                    </td>
                  ...
                  <tr valign="top">
                    <th scope="row">
                      <label for="submission_email_addresses">
                        <?php _e( 'Notification email addresses:', 'badgeos' ); ?>
                      </label>
                    </th>
                    <td>
                      ...
                      <p class="description">
                        <?php _e( 'Comma-separated list of email addresses to send submission/nomination notifications, in addition to the Site Admin email.', 'badgeos' ); ?>
                      </p>
                    </td>
                  </tr>
                  <tr valign="top">
                    <th scope="row">
                      <label for="svg_support">
                        <?php _e( 'SVG Support:', 'badgeos' ); ?>
                      </label>
                    </th>
                    <td>
                      <select id="svg_support" name="badgeos_settings[svg_support]">
                        <option value="disabled" <?php selected( $svg_support, 'disabled' ); ?>>
                          <?php _e( 'Disabled', 'badgeos' ) ?>
                        </option>
                        <option value="enabled" <?php selected( $svg_support, 'enabled' ); ?>>
                          <?php _e( 'Enabled', 'badgeos' ) ?>
                        </option>
                      </select>
                      <p class="description">
                        <?php _e('SVG-image support is required for Badges with images designed inside Open Badge Factory. If you are not already using another plugin that provides SVG-support, please keep this enabled. Enabling this does not allow users to upload SVG-images, it only affects badges imported from Open Badge Factory.', 'badgeos'); ?>
                      </p>
                    </td>
                  </tr>
                  <tr valign="top">
                    ...
                    <td>
                      <select id="debug_mode" name="badgeos_settings[debug_mode]">
                        <option value="disabled" <?php selected( $debug_mode, 'disabled' ); ?>>
                          <?php _e( 'Disabled', 'badgeos' ) ?>
                        </option>
                        <option value="enabled" <?php selected( $debug_mode, 'enabled' ); ?>>
                          <?php _e( 'Enabled', 'badgeos' ) ?>
                        </option>
                      </select>
                    </td>
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <textarea name="badgeos_settings[email_body]" id="email-body" rows="10" cols="40" maxlength="65535" class="form-control" value="<?php echo esc_textarea( $email_body ); ?>">
                                <?php echo esc_textarea( $email_body ); ?>
                              </textarea>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div>
                              ...
                              <p class="description">
                                <?php _e('Text used in receive badge link button.', 'badgeos'); ?>
                              </p>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div>
                              <textarea name="badgeos_settings[email_footer]" id="email-footer" rows="5" cols="40" maxlength="65535" class="form-control" value="<?php echo esc_textarea( $email_footer ); ?>">
                                <?php echo esc_textarea( $email_footer ); ?>
                              </textarea>
                            </div>
                          </div>
                        </td>
        ...
        if ( is_multisite() ) {
            ?>
                        <tr valign="top">
                          <th scope="row">
                            <label for="debug_mode">
                              <?php _e( 'Show achievements earned across all sites on the network:', 'badgeos' ); ?>
                            </label>
                          </th>
                          <td>
                            <select id="debug_mode" name="badgeos_settings[ms_show_all_achievements]">
                              <option value="disabled" <?php selected( $ms_show_all_achievements, 'disabled' ); ?>>
                                <?php _e( 'Disabled', 'badgeos' ) ?>
                              </option>
                              <option value="enabled" <?php selected( $ms_show_all_achievements, 'enabled' ); ?>>
                                <?php _e( 'Enabled', 'badgeos' ) ?>
                              </option>
                            </select>
                          </td>
...
function badgeos_add_ons_page() {
    ...
    <div class="wrap badgeos-addons">
      ...
      <p>
        <?php _e( 'These add-ons extend the functionality of the Open Badge Factory -plugin.', 'badgeos' ); ?>
      </p>
...
function badgeos_help_support_page() { ?>
    ...
    if (badgeos_user_can_manage_achievements()) {
        ?>
          <div class="card">
            ...
            <ol>
              <li>
                <?php _e('Get the Open Badge Factory API certificate from Open Badge Factory (<strong>Admin tools > Api Key > Generate certificate signing request token', 'badgeos'); ?></strong>)
                  <li>
                    <?php _e('Enter the generated Open Badge Factory API key in your wordpress\' <strong>Open Badge Factory > OBF Integration</strong> -page to enable badge sharing.', 'badgeos'); ?></li>
                  <li>
                    <?php _e('Set up awarding rules for your badges in your wordpress\' <strong>Open Badge Factory > Badges</strong> -page.', 'badgeos'); ?></li>
            </ol>
            ...
            <?php add_thickbox(); $apikey_image_url = badgeos_get_directory_url() .'/doc/install/generated_api_key.png' ?>
              <div id="api-key-image-full" style="display:none;">
                <p><img class="obf-help-image" src="<?php echo $apikey_image_url; ?>" alt="Generated API key" title="Generated API key" /></li>
                </p>
              </div>
        ...
        <img class="obf-help-image thumbnail" src="<?php echo $apikey_image_url; ?>" alt="Generated API key" title="Generated API key" /></li>
              ...
              <?php $step_image_url = badgeos_get_directory_url().'/doc/install/wp_plugin_steps.png'; ?>
                <div id="steps-image-full" style="display:none;">
                  <p><img class="obf-help-image" src="<?php echo $step_image_url; ?>" alt="Required steps" title="Required steps" /></li>
                  </p>
                </div>
                <h3><?php _e('II. Creating awarding rules', 'badgeos'); ?></h3>
                <p>
                  <?php echo sprintf(__('To create badge awarding rules you should have a badge or badges created at <a href="%s">Open Badge Factory</a>.', 'badgeos'), 'https://openbadgefactory.com'); ?></p>
                <p>
                  <?php _e('If everything is set up, you should have a <strong>Open Badge Factory > Badges</strong> -menu item in your wordpress admin dashboard.', 'badgeos'); ?></p>
                <p>
                  <?php _e('Badges -page contains all the ready to be issued badges you\'ve created in Open Badge Factory. If a badge you have created isn\'t visible, make sure it is not set as a draft.', 'badgeos'); ?>
                </p>
                <p>
                  <?php _e('If you open a badge for editing, you can choose from multiple earning options. The most flexible earning option is using required steps. You can add one or multiple steps a user needs to complete in order to earn the badge.', 'badgeos'); ?>
                </p>
                <p>
        ...
        <img class="obf-help-image thumbnail" src="<?php echo $step_image_url; ?>" alt="Required steps" title="Required steps" /></li>
                ...
                <p>
                  <?php _e('After you save a with awarding rules, the badge associated with the awarding rule will be automatically awarded to users who complete the required steps.', 'badgeos'); ?>
                </p>
                <p>
                  <?php _e('You can monitor user step unlocking process and achivements via the <strong>Log Entries</strong> menu.', 'badgeos'); ?></p>
                <p>
                  <?php _e('You can also define meta-achivements by adding badges as required steps. Choose <strong>Specific Achievement of Type &gt; Badges &gt; your badge</strong> at Required Steps.', 'badgeos'); ?></p>

                <h3><?php _e('III. Advanced features', 'badgeos'); ?></h3>
                <p>
                  <?php _e('When you are confident with setting up and creating awarding rules, you may choose to enable advanced features.', 'badgeos'); ?>
                </p>
                <p>
                  <?php _e('Advanced features can be enabled on the <strong>Open Badge Factory &gt; Settings</strong> -page, by changing <strong>Show advanced features</strong> to <strong>Enabled</strong>.', 'badgeos'); ?></p>
                <p>
                  <?php _e('After enabling advanced features, you can rename achievement types, access submissions and nominations from the menu, and map badge fields to wordpress fields.', 'badgeos'); ?>
                </p>
          </div>
          <?php
    }
    ...
    if (badgeos_user_can_manage_submissions()) {
        ?>
              <div class="card">
                ...
                <p>
                  <?php _e('You can award badges through approved submissions. Create a page or post, insert Open Badge Factory shortcode Submission Form and the Achievement ID of the badge you wish to issue. Publish the post so your users can leave submissions to earn the badge.', 'badgeos'); ?>
                </p>
                <p>
                  <?php _e('You can see all your users submissions at <strong>Open Badge Factory &gt; Submissions</strong> -page. Review and comment the submissions to award the badge.', 'badgeos'); ?></p>
                <p>
                  <?php _e('You can specify the role who can approve submissions/nominations at <strong>Open Badge Factory &gt; Setting</strong> -page.', 'badgeos'); ?></p>
              </div>
              <?php
    }
    ?>
    ...
    __( 'Open Badge Passport', 'badgeos' )
                  ...
                  <p>
                    <?php printf( __( 'Please submit bugs or issues to %s for the Open Badge Factory Project.', 'badgeos' ), '<a href="https://github.com/discendum" target="_blank">Github</a>' ); ?></p>
...
function badgeos_credly_options_no_api( $credly_settings = array() ) {
    ...
    ?>
          <div id="credly-settings">
            ...
            <p class="toggle">
              <?php _e( 'Enter your Credly account username and password to access your API key.', 'badgeos' ); ?>
            </p>

            <p class="toggle hidden">
              <?php printf( __( 'Enter your %s to access your API key.', 'badgeos' ), '<a href="#show-api-key">'. __( 'Credly account username and password', 'badgeos' ) .'</a>' ); ?></p>

            <table class="form-table">
              <tr valign="top">
                <th scope="row">
                  <label for="credly_user">
                    <?php _e( 'Username: ', 'badgeos' ); ?>
                  </label>
                </th>
                <td>
              ...
              <tr valign="top">
                <th scope="row">
                  <label for="credly_password">
                    <?php _e( 'Password: ', 'badgeos' ); ?>
                  </label>
                </th>
                <td>
            ...
            <p class="toggle">
              <?php printf( __( 'Already have your API key? %s', 'badgeos' ), '<a href="#show-api-key">'. __( 'Click here', 'badgeos' ) .'</a>' ); ?></p>
          </div>
          <?php
...
function badgeos_credly_options_yes_api( $credly_settings = array() ) {
    ...
    ?>
            <div id="credly-settings">
              ...
              <p>
                <?php _e( 'Customize which Credly fields for badge creation and issuing (listed on the left) match which WordPress and Open Badge Factory -plugin fields (listed to the right).', 'badgeos' ); ?>
                  <br />
                  <?php _e( 'When badges are created and issued, the info sent to Credly will rely on the global mapping found here. (Note: Visit the edit screen for each achievement you create in Open Badge Factory to further configure the sharing and awarding settings for that achievement.)', 'badgeos' ); ?>
              </p>
              <table class="form-table">
                <tr valign="top">
                  <th scope="row">
                    <label for="credly_badge_title">
                      <?php _e( 'Badge Title: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row">
                    <label for="credly_badge_short_description">
                      <?php _e( 'Short Description: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row">
                    <label for="credly_badge_description">
                      <?php _e( 'Description: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                    <select id="credly_badge_description" name="credly_settings[credly_badge_description]">
                ...
                <tr valign="top">
                  <th scope="row">
                    <label for="credly_badge_criteria">
                      <?php _e( 'Criteria: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row">
                    <label for="credly_badge_image">
                      <?php _e( 'Image: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                ...
                <tr valign="top">
                  <th scope="row">
                    <label for="credly_badge_testimonial">
                      <?php _e( 'Testimonial: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                    <select id="credly_badge_testimonial" name="credly_settings[credly_badge_testimonial]">
                ...
                <tr valign="top">
                  <th scope="row">
                    <label for="credly_badge_evidence">
                      <?php _e( 'Evidence: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
              ...
              <p>
                <?php _e( 'Send custom notifications to users when they earn a Credly-enabled achievement.', 'badgeos' ); ?>
              </p>

              <table class="form-table credly-notifications">
                <tr valign="top" class="credly-notifications-enable-message">
                  <th scope="row">
                    <label for="credly_badge_sendemail_add_message">
                      <?php _e( 'Add a global custom message to each notification: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                    <select id="credly_badge_sendemail_add_message" name="credly_settings[credly_badge_sendemail_add_message]">
                      <option value="false" <?php selected( $credly_settings[ 'credly_badge_sendemail_add_message' ], 'false' ); ?>>
                        <?php _e( 'No', 'badgeos' ) ?>
                      </option>
                      <option value="true" <?php selected( $credly_settings[ 'credly_badge_sendemail_add_message' ], 'true' ); ?>>
                        <?php _e( 'Yes', 'badgeos' ) ?>
                      </option>
                    </select>
                  </td>
                ...
                <tr valign="top" class="credly-notifications-message">
                  <th scope="row">
                    <label for="credly_badge_sendemail">
                      <?php _e( 'Custom notification message: ', 'badgeos' ); ?>
                    </label>
                  </th>
                  <td>
                    <textarea id="credly_badge_sendemail_message" name="credly_settings[credly_badge_sendemail_message]" cols="80" rows="10">
                      <?php echo esc_textarea( $credly_settings[ 'credly_badge_sendemail_message' ] ); ?>
                    </textarea>
                  </td>
                </tr>
              </table>
